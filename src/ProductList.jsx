...
import "./ProductList.css"; // Ensure you have this CSS file for styling
  ...
  const plantsArray = [
    {
      ...
      plants: [
        ...
        },
        {
          ...
          description: "Purifies air and has healing properties for skin.",
          cost: "$14",
        },
      ],
    },
    {
      ...
      plants: [
        ...
        },
        {
          ...
          description: "Citrusy scent, relieves stress and anxiety.",
          cost: "$14",
        },
        {
          name: "Hyacinth",
    ...
    },
    {
      ...
      plants: [
        ...
        },
        {
          ...
          description:
            "Known for their insect-repelling properties while adding pleasant scent.",
          cost: "$20",
        },
        {
          name: "Basil",
    ...
    },
    {
      ...
      plants: [
        ...
        },
        {
          name: "Peppermint",
          image:
            "https://cdn.pixabay.com/photo/2017/07/12/18/54/mint-2500112_1280.jpg",
    ...
    },
    {
      ...
      plants: [
        ...
        },
        {
          ...
          image:
            "https://cdn.pixabay.com/photo/2021/01/22/06/04/snake-plant-5939187_1280.jpg",
          description: "Needs infrequent watering and resilient to pests.",
          cost: "$15",
        },
        {
          ...
          description: "Hardy plant that can survive low light and neglect.",
          cost: "$20",
        },
        {
          name: "Succulents",
                ...
                {category.plants.map((plant, plantIndex) => (
                  <div className="product-card" key={plantIndex}>
                    ...
                    <button
                      ...
                      disabled={!!addedToCart[plant.name]} // Disable button if product is in cart
                    >
