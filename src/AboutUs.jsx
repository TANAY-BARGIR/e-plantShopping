...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-content">
        Our team of experts is dedicated to ensuring that every plant you
        purchase is healthy and thriving. We offer detailed care instructions
        and support to help you nurture your green friends. Whether you're a
